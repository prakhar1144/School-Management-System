...
from .views import Home,Faculty,Faculty_detail,Student, Class_detail,Finance,Student_finance,Due_detail,Staff,Staff_detail,Faculty_finance,Staff_finance
